...
### Database (Mysql) for project traffic light (State Machine)
#### Package com.statemachine.incubator.example
```
docker run --name traffic-light -e MYSQL_ROOT_PASSWORD=123456 -e MYSQL_DATABASE=traffic-light-db -p 3306:3306 -d mysql:latest
```
